...
/*所有需要的参数信息都在此处以#define的形式提供, 在windows环境下文件需要全路径,注意文件路径中的双斜线*/
#define CERTF "C:\\...\\...\\server\\server-cert.pem"/*服务端的证书(需经CA签名)*/
#define KEYF "C:\\...\\...\\server\\server-key.pem" /*服务端的私钥(建议加密存储)*/
#define CACERT "C:\\...\\...\\ca\\ca-cert.pem" /*CA 的证书*/
#define PORT 4433/*准备绑定的端口*/
